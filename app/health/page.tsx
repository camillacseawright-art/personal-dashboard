...
import { Plus, Trash2, CheckCircle2, Circle, Stethoscope } from "lucide-react"
...
export default function HealthPage() {
  ...
  const [form, setForm] = useState({ memberName: "", recordType: "appointment", provider: "", scheduledDate: "", notes: "" })
  ...
  async function addRecord(e: React.FormEvent) {
    ...
    setForm({ memberName: "", recordType: "appointment", provider: "", scheduledDate: "", notes: "" })
    setOpen(false)
  }
    ...
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild><Button className="bg-[#C8553D] hover:bg-[#A8442F]"><Plus className="h-4 w-4" /> Add Record</Button></DialogTrigger>
          <DialogContent>
            ...
            <form onSubmit={addRecord} className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1"><Label>Type</Label>
                  <Select value={form.recordType} onValueChange={v => setForm(f => ({ ...f, recordType: v }))}>
                    ...
                    <SelectContent>
                      {["appointment","well-visit","vaccination","dentist","prescription","therapy","specialist","checkup"].map(t =>
              ...
              <Button type="submit" className="w-full bg-[#C8553D] hover:bg-[#A8442F]">Add Record</Button>
            </form>
          </DialogContent>
        </Dialog>
      </div>
